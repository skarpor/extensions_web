...
from api.v1.endpoints.email import router as email_router  # 导入邮件路由
...
# 添加邮件路由
api_router.include_router(email_router, prefix="/email", tags=["邮件"])
