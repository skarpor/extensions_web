...
const showUserDropdown = ref(false) // 确保这里正确定义了
let dropdownTimeout = ref(null)
...
const currentUser = computed(() => user.value || defaultUser)
onMounted(async () => {
  try {
    Toast.info('欢迎访问！')
    // 初始化用户状态
  ...
  <div class="app-container">
        ...
        <li class="nav-item">
          <RouterLink class="nav-link" to="/help" :class="{ 'active': $route.path === '/help' }">
            <i class="fas fa-question-circle"></i> 帮助中心
                ...
                <li class="nav-item" v-if="!isLoggedIn">
          <RouterLink class="nav-link login-btn" to="/login">
            <i class="fas fa-sign-in-alt"></i> 登录
          </RouterLink>
        </li>
        <li class="nav-item user-info" v-else
            @mouseenter="handleMouseEnter"
            @mouseleave="handleMouseLeave">
              <!-- 用户头像和名称 -->
    <div class="user-avatar">
      <img :src="currentUser.avatar || 'https://via.placeholder.com/40'" alt="User">
    </div>
    ...
    <div class="user-dropdown"
      ...
      <div class="dropdown-header">
        <img :src="currentUser.avatar || 'https://via.placeholder.com/80'" alt="User">
