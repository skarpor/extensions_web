...
// 获取下载链接
export const downloadRestoreFile =async (filename) => {
  return await axios.get(`/api/qrfile/download/${filename}`)
}

// 从文本内容恢复文件
export const restoreFromText = async (textData) => {
  return await axios.post('/api/qrfile/restore-from-text', { 'text_data':textData })
}
